...
def number4():
    ...
    text1 = Label(root6, text="Открой IDLE Python, сделай синий прямоугольник 70 на 50", fg="Black", bg="White",
                  font="Bahnschrift 20")
...
def number7():
    ...
    z2 = Label(root, text="Напиши верную кодировку (писать слитно): ", fg="Black", bg="white",
               font="Bahnschrift 20")
    otv2 = Entry(root, fg="Black", bg="white", font="Bahnschrift 20")
    provbutt = Button(root, text="Проверить ответы", fg="Black", bg="white", border=1,
